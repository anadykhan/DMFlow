...
const Sidebar = ({ slug }: Props) => {
  const { page } = usePaths();
  return (
    <div className="w-[250px] border-[1px] radial fixed left-0  border-[#545454] bg-gradient-to-b from-[#768bdd] via-[#0e0e0e] to-[#768bdd] lg:inline-block bottom-0 top-0 m-3 rounded-3xl overflow-hidden">
